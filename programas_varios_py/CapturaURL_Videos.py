...
Tienes que tener un vídeo reproduciéndose en tu navegador (por ejemplo YouTube);
el script lo pausa, copia su URL de la barra de direcciones y la guarda en Excel.
