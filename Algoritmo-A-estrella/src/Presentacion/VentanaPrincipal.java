...
public class VentanaPrincipal extends javax.swing.JFrame implements
	...
	private String stringTamanoTiempoTablero;
	...
	private void create() {
		...
		stringTamanoTiempoTablero = "Tablero[ " + anchuraTablero + "x"
				+ alturaTablero + " ]";

		panelInputsTam.setBorder(BorderFactory
				.createTitledBorder(stringTamanoTiempoTablero));
	...
	/**
	 * Action Listener com�n para lso elementos de la ventana
	 * 
			...
			if (event.getSource() == jButtonComenzar) {
				try {
					...
					if (xInicio > anchuraTablero - 1)
						...
						// Se manda la peticion para calcular el camino m�s
	...
	/**
	 * Key Listener com�n para lso elementos de la ventana
	 * 
	 * @author Rodrigo de Miguel
	 * 
	 */
	...
	/**
	 * Focus Listener com�n para lso elementos de la ventana
	 * 
	 * @author Rodrigo de Miguel
	 * 
	 */
